  ...
  return (
    ...
    <Wrapper>
      <div className='flex items-center gap-x-2'>
        ...
        <h1 className='font-semibold'>Diagram.io</h1>
      </div>
        <div className='h-full mt-44 flex-col  flex items-center justify-center'>
             ...
             className='mt-4  lg:w-[20%]  md:w-[40%] sm:w-[50%]  w-[40%] '>Create Team</Button>
        </div>
    </Wrapper>
    </>
  )
